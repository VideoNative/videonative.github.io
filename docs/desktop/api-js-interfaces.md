...
对象 | 接口 | 支持 | 说明
---             | ---                                     | --- | ---
vn		|void scanCode(Object object)		  | 不支持 | ---
---		|Float toRpx(String value)		  | 不支持 | ---
---		|void getSystemInfo(Object object)	  | 不支持 | ---
vn.dom		|Object getElementById(String id)	  | --- | ---
---		|fullscreenElement()		          | 不支持 | ---
---		|exitFullscreen()		          | 不支持 | ---
DOM对象		|Object getParentElement()		  | --- | ---
...
---		|Float getRotationY()			  | --- | ---
---		|setRotationY(Float)			  | --- | ---
---		|requestFullscreen()			  | 不支持 | ---
vn.window	|Float getScreenWidth()			  | --- | ---
---		|Float getScreenHeight()		  | --- | ---
---		|String getOrientationSetting()		  | 不支持 | ---
---		|String getCurOrientation()		  | 不支持 | ---
---		|setOrientation(String orientation)	  | 不支持 | ---
---		|Boolean isDialog()		          | --- | ---
console		|log(Object message)		          | --- | ---
vn.data		|Object query(String keyPath)		  | --- | ---
...
vn.request	|Integer request(Object requestOrigin)	  | --- | ---
---		|cancel(Integer requstId)		  | --- | ---
vn.storage	|setStorage(Object object)		  | --- | ---
---		|getStorage(Object object)		  | --- | ---
---		|removeStorage(Object obect)		  | --- | ---
---		|clearStorage(Object obect)		  | --- | ---
vn.navigate	|navigateTo(Object obj)		          | --- | ---
---		|redirectTo(Object obj)		          | --- | ---
---		|navigateBack(Object obj)		  | --- | ---
---		|relaunch(Object obj)		          | --- | ---
vn.app		|String getSDKVersionName()		  | --- | ---
...
---		|getWindowHeight		          | --- | ---
---		|resize(wt, ht)				  | --- | ---
---		|setCaptionArea(x, y, wt, ht, bClearBefore)  | --- | ---
---		|maximize()				  | --- | ---
---		|restore()				  | --- | ---
---		|minimize()				  | --- | ---
---		|isIconic()				  | --- | ---
...
---		|bringToTop()				  | --- | ---
---		|getLayered()				  | --- | ---
---		|setLayered(bool layered)		  | --- | ---
---		|setMinSize(wt, ht)		          | --- | ---
---		|setMaxSize(wt, ht)		          | --- | ---
---		|getAlpha		 		  | --- | ---
---		|setAlpha(alpha)		          | --- | ---
---		|setFixSize(bool value)		          | --- | ---
---		|setFixPosition(bool value)		  | --- | --- 
---		|setTopmost(bool value)			  | --- | --- 
---		|setToolWindow(bool value)		  | --- | --- 
