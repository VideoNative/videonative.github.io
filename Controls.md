...
## button
button是点击交互控件。和text不同的地方是有默认的系统UI，以及点击时有系统默认的视觉效果
...
<!--text.vnml-->
<view width="100%" height="auto" flex-direction="row">
    <button height="auto" width="auto" font-size="30rpx" color="#000000FF" font-style="bold" text-align="center">点击我</button>
</view>
```
